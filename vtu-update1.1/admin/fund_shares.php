    ...
    <div class="flex h-screen bg-gray-200">
        ...
        <div class="w-64 bg-gray-800 text-white p-4">
            ...
            <nav>
                ...
                <a href="fund_shares.php" class="block py-2.5 px-4 rounded transition duration-200 bg-gray-700">Fund Shares</a>
        ...
        <div class="flex-1 p-10 overflow-y-auto">
            <h1 class="text-3xl font-bold mb-6">Fund Shares</h1>
